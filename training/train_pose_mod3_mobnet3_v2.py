...
sys.path.append("..")
from model_mod3_mobnet import get_training_model, get_testing_model
...
parser.add_argument('--palpha',  required=False, help='model parameter: alpha', default=0.5, type=float)
parser.add_argument('--pstages', required=False, help='model parameter: stages', default=3, type=int)
