...
def stage1_block_mobilenet(x, num_p, branch, weight_decay, palpha = 1.0, depth_multiplier=1):
    # Block 1
    x = _depthwise_conv_block_mod(x, 92, palpha, depth_multiplier, block_name="Mconv1_stage1_L%d" % branch)
...
def stageT_block_mobilenet(x, num_p, stage, branch, weight_decay, palpha = 1.0, depth_multiplier=1):
    x = _depthwise_conv_block_mod(x, 92, palpha, depth_multiplier, block_name="Mconv1_stage%d_L%d" % (stage, branch))
